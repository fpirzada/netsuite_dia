...
<div class="facets-item-cell-list" data-track-productlist-list="{{track_productlist_list}}" data-track-productlist-category="{{track_productlist_category}}" data-track-productlist-position="{{track_productlist_position}}" data-sku="{{sku}}" itemprop="itemListElement">
	...
	<div class="facets-item-cell-list-right">
		...
		{{#if showRating}}
		<div class="facets-item-cell-list-rating" data-view="GlobalViews.StarRating">
		</div>
		{{/if}}
